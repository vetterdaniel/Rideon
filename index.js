...
var gpx = 'Hannerup.gpx';

		new MAP.GPX(gpx, {async: true,
		    ...
		    e.target.bindPopup('<b>Navn:</b> ' + e.target.get_name() + '<br><b>Distance:</b> ' + e.target.get_distance_km().toFixed(2) + ' Km <br> <b>Stigning:</b> ' + e.target.get_elevation_gain().toFixed(2) + ' m <br><b> Fald:</b> ' + e.target.get_elevation_loss().toFixed(2) + ' m');
